...
\end{align}
Where $\vec{I}$ is $2 \times 2$ Identity matrix. Now using Cayley Hamilton Theorem we get from \eqref{eqEigen} the following,
\begin{align}
\vec{A}^2 - 5\vec{A}+7\vec{I} &= 0\label{eqCH}
\end{align}
...
&= 6(\vec{A-I})^2 \quad{\text{[From \eqref{eqCH}]}}\\
