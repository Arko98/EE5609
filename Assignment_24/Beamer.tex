...
\vspace{3cm}
\title{Matrix Theory (EE5609) Assignment 24}
...
\begin{abstract}
This document solves problem on ideals. 
\end{abstract}
...
Let $\vec{A} = \myvec{1&-1&1\\1&1&1\\2&3&\alpha}$ and $\vec{b}= \myvec{1\\3\\\beta}$. Then the system $\vec{AX}=\vec{b}$ over the real numbers has\\
\begin{enumerate}
...
&\xleftrightarrow{R_3=R_3-5R_2}\myvec{1&0&1&2\\0&1&0&1\\0&0&\alpha-2&\beta-7}\label{eq}
\end{align}
From the RREF of the augmented matrix of the system $\vec{AX} = \vec{b}$ in \eqref{eq} we make the following observations for different values of $\alpha$ and $\beta$, 
\begin{table}[h!]
\begin{center}
\begin{tabular}{|c|c|}
\hline
...
\hline
& Then RREF in \eqref{eq} will contain \\
$\alpha = 7$ & Zero Row in $R_3$. Moreover solvability\\
$\beta \ne 7$ & condition will not satisfy. \\
& $\implies$ system will have Zero solutions\\
\hline
& RREF in \eqref{eq} will have all pivots\\
$\alpha \ne$ 2 & $\implies$ RREF in \eqref{eq} will be fullrank\\
