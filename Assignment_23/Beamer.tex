...
\vspace{3cm}
\title{Matrix Theory (EE5609) Assignment 23}
...
\begin{lstlisting}
https://github.com/Arko98/EE5609/blob/master/Assignment_23
\end{lstlisting}
\section{\textbf{Problem}}
Let $\mathbb{Q}$ be the field of rational numbers. Determine if the following subset of $\mathbb{Q}[x]$ is ideal or not. The subset is defined by all $f$ with degree $\geq 5$
